        ...
        : CinemachineVirtualCameraBaseEditor<CinemachineStateDrivenCamera>
        {
            ...
            protected override void OnEnable()
            {
                ...
                m_BlendsEditor.OnCreateEditor = (UnityEditor.Editor ed)=>
                {
                    ...
                    if (editor != null)
                        editor.GetAllVirtualCameras = ()=>
                        {
                            return Target.ChildCameras;
                        };
                };
                mChildList = null;
            ...
            private void UpdateTargetStates()
            {
                ...
                List<CinemachineStateDrivenCamera.ParentHash> parents = new List<CinemachineStateDrivenCamera.ParentHash>();
            ...
            void SetupInstructionList()
            {
                ...
                mInstructionList.drawElementCallback = (Rect rect, int index, bool isActive, bool isFocused)=>
                {
            ...
            void SetupChildList()
            {
                ...
                mChildList.drawElementCallback = (Rect rect, int index, bool isActive, bool isFocused)=>
                {
                    rect.y += vSpace;
                    rect.height = EditorGUIUtility.singleLineHeight;
                    rect.width -= floatFieldWidth + hBigSpace;
