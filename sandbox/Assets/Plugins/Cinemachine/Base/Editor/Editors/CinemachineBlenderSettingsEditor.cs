...
namespace Cinemachine.Editor
{
    ...
    internal sealed class CinemachineBlenderSettingsEditor : BaseEditor<CinemachineBlenderSettings>
    {
        ...
        void SetupBlendList()
        {
            ...
            mBlendList.drawElementCallback = (Rect rect, int index, bool isActive, bool isFocused)=>
            {
            ...
            mBlendList.onAddCallback = (ReorderableList l)=>
            {
                ...
                blendProp.FindPropertyRelative(()=> def2.m_Style).enumValueIndex = (int)CinemachineBlendDefinition.Style.EaseInOut;
