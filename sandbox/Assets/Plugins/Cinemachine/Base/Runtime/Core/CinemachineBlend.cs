...
namespace Cinemachine
{
    ...
    public class CinemachineBlend
    {
        ...
        public float BlendWeight
        {
            get
            {
                return BlendCurve != null ? BlendCurve.Evaluate(TimeInBlend): 0;
            }
        }
            ...
            get
            {
                ...
                switch (m_Style)
                {
                    ...
                    case Style.EaseInOut:
                            return AnimationCurve.EaseInOut(0f, 0f, time, 1f);
                    case Style.EaseIn:
                        {
                    ...
                    case Style.Linear:
                            return AnimationCurve.Linear(0f, 0f, time, 1f);
                }
            }
        }
    }
